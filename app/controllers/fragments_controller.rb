class FragmentsController < ApplicationController
  ...
  def learn
    @current_line = params[:lines].to_i
    @fragment = Fragment.find(params[:id])
    @total_lines = @fragment.body.lines.count
    @lines = @fragment.body.lines.first(@current_line).join('<br>')
  end
  ...
  private
    ...
    def fragment_params
      params.require(:fragment).permit(:title, :body)
    end
end
